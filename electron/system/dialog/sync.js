 ...
 *
 */
const message = (window, options) => dialog.showMessageBoxSync(window, options);
 ...
 *
 */
const open = (window, options) => dialog.showOpenDialogSync(window, options);
 ...
 *
 */
const save = (window, options) => dialog.showSaveDialogSync(window, options);

/**
 * The `error()` displays a modal dialog that shows an error message.
 *
 ...
 * called before the app `ready` event on Linux, the message will be emitted to
 * stderr, and no GUI dialog will appear.
 *
 * @param {object} options - The title to display in the error box.
 * @param {string} options.title - The title to display in the error box.
 * @param {string} options.content - The text content to display in the error box.
 * @returns {void}
 * @example error({
 *   title: 'An error has occurred',
 *   content: 'The file was not found at the indicated path',
 * });
 *
 */
